...
<div id="primary" class="content-area-detail homepage-content">
        <div id="content" class="content-detail" role="main">
            <div class="content-body">
				...
				<h1 class="entry-title"><?php echo (__("Search Results","foreignaffairs" )); ?></h1>
                    ...
                    <?php if ( is_active_sidebar("twitter-1") || is_active_sidebar("twitter-2") ): ?>
                        <div class="twitter-widget">
                            ...
                            <ul class="nav nav-tabs">
                                <li><a href="#mfa" data-toggle="tab"><?php echo (__('Follow MFA', 'foreignaffairs')) ?></a></li>
                            </ul>

                            <!-- Tab panes -->
                            <div class="tab-content">
                                <div class="tab-pane active" id="mfa">
