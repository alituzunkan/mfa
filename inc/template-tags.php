<?php
/**
 * Custom template tags for Foreign Affairs
 *
 * @package WordPress
...
function twentyfourteen_paging_nav() {
	...
	?>
	<nav class="pip-nav" role="navigation">
...
function twentyfourteen_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php _e( 'Post navigation', 'foreignaffairs' ); ?></h1>
		<div class="nav-links">
			<?php
			if ( is_attachment() ) :
				previous_post_link( '%link', __( '<span class="meta-nav">Published In</span>%title', 'foreignaffairs' ) );
			else :
				previous_post_link( '%link', __( '<span class="meta-nav">Previous Post</span>%title', 'foreignaffairs' ) );
				next_post_link( '%link', __( '<span class="meta-nav">Next Post</span>%title', 'foreignaffairs' ) );
			endif;
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
...
function twentyfourteen_posted_on() {
	if ( is_sticky() && is_home() && ! is_paged() ) {
		echo '<span class="featured-post">' . __( 'Sticky', 'foreignaffairs' ) . '</span>';
	}
