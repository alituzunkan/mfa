<?php
/**
 * Implement Custom Header functionality for Foreign Affairs
 *
 * @package WordPress
...
function twentyfourteen_custom_header_setup() {
	/**
	 * Filter Foreign Affairs custom-header support arguments.
	 *
	 * @since Foreign Affairs 1.0
	 *
	 * @param array $args {
...
function twentyfourteen_header_style() {
	...
	?>
	<style type="text/css" id="foreignaffairs-header-css">
	<?php
...
?>
	<style type="text/css" id="foreignaffairs-admin-header-css">
