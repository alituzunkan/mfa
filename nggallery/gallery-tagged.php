...
<div class="ngg-galleryoverview ngg-template custom-temp" id="<?php echo $gallery->anchor ?>">
...
<?php } ?>
	...
	$tagString = mb_substr($tagString, 0, -2);
	?>
	
	<div id="ngg-image-<?php echo $image->pid ?>" class="ngg-gallery-thumbnail-box" <?php echo $image->style ?> >
		<div class="ngg-gallery-thumbnail" >
			<a href="<?php echo nextgen_esc_url($image->imageURL) ?>"
               title="<?php echo esc_attr($image->description) ?> <?php if($tagString){echo ('<div class=\'fancytags\'>Tags:'.$tagString.'</div>');} ?>"
